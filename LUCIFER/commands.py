...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url='https://t.me/Update_Channel7'),
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url='https://t.me/Update_Channel7')
                  ]]
        ...
        try:
            if IS_VERIFY and not await check_verification(client, message.from_user.id):
                btn = [[
                    ...
                    InlineKeyboardButton("❗Hᴏᴡ Tᴏ Vᴇʀɪғʏ❗", url="https://t.me/VisionBackup/328")
                ]]
                return await message.reply_text(
                    text=f"<b>Hᴇʏ Tʜᴇʀᴇ {message.from_user.mention}\n\n📌 <u><i>Yᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ ᴛᴏᴅᴀʏ,\nPʟᴇᴀsᴇ ᴠᴇʀɪғʏ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ᴜɴᴛɪʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴡʜɪᴄʜ ɪs ᴀғᴛᴇʀ 𝟸 ʜᴏᴜʀs ғʀᴏᴍ ɴᴏᴡ.</i>/u></b>",
                    protect_content=True,
                    reply_markup=InlineKeyboardMarkup(btn)
                )
